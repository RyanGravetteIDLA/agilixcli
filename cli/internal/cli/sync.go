...
Resource scoping:
  ...
  agilix-buzz-pp-cli sync

  # Sync specific resources only
  agilix-buzz-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  agilix-buzz-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  agilix-buzz-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  agilix-buzz-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  agilix-buzz-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("agilix-buzz-pp-cli")
			}
			...
			for res := range results {
				if res.Err != nil {
					if humanFriendly {
						...
						// DLAP list endpoints require a domainid; surface the
						// sync-specific way to supply it.
						if strings.Contains(strings.ToLower(res.Err.Error()), "domainid") {
							fmt.Fprintf(os.Stderr, "    hint: most Buzz resources require a domain scope; add --global-param domainid=<id> (and --global-param includedescendantdomains=true to walk the subtree)\n")
						}
					}
					errCount++
					if firstErr == nil {
...
func resourceSupportsPagination(resource string) bool {
	...
	case "items":
		return true
	case "objectives-cmd?cmd=listobjectivesets":
		return true
	case "users":
		return true
	}
...
func defaultSyncResources() []string {
	return []string{
		"announcements",
		"announcements-cmd?cmd=getuserannouncementlist",
		"announcements-cmd?cmd=listrestorableannouncements",
		"assessments",
		"assessments-cmd?cmd=listrestorablequestions",
		"badges",
		"blogs",
		"courses",
		"discussions",
		"discussions-cmd?cmd=listrestorablemessages",
		"domains",
		"domains-cmd?cmd=getdomainparentlist",
		"enrollments",
		"enrollments-cmd?cmd=getenrollmentgrouplist",
		"enrollments-cmd?cmd=listenrollmentsbyteacher",
		"enrollments-cmd?cmd=listentityenrollments",
		"enrollments-cmd?cmd=listuserenrollments",
		"files",
		"files-cmd?cmd=listrestorabledocuments",
		"files-cmd?cmd=listrestorableresources",
		"gradebook",
		"gradebook-cmd?cmd=getgradebooklist",
		"groups",
		"groups-cmd?cmd=getgroupenrollmentlist",
		"items",
		"items-cmd?cmd=findpersonalizedentities",
		"items-cmd?cmd=getitemlist",
		"items-cmd?cmd=listassignableitems",
		"items-cmd?cmd=listrestorableitems",
		"objectives",
		"objectives-cmd?cmd=getobjectivemaplist",
		"objectives-cmd?cmd=getobjectivesubjectlist",
		"objectives-cmd?cmd=listobjectivesets",
		"peergrading",
		"reports",
		"reports-cmd?cmd=getrunnablereportlist",
		"rights",
		"rights-cmd?cmd=geteffectivesubscriptionlist",
		"rights-cmd?cmd=getentitysubscriptionlist",
		"rights-cmd?cmd=getrightslist",
		"rights-cmd?cmd=getsubscriptionlist",
		"system",
		"tokens",
		"users",
		"wikis",
		"wikis-cmd?cmd=listrestorablewikipages",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"announcements": "/cmd?cmd=getannouncementlist",
		"announcements-cmd?cmd=getuserannouncementlist":     "/cmd?cmd=getuserannouncementlist",
		"announcements-cmd?cmd=listrestorableannouncements": "/cmd?cmd=listrestorableannouncements",
		"assessments": "/cmd?cmd=listquestions",
		"assessments-cmd?cmd=listrestorablequestions": "/cmd?cmd=listrestorablequestions",
		"badges":      "/cmd?cmd=getbadgelist",
		"blogs":       "/cmd?cmd=getbloglist",
		"courses":     "/cmd?cmd=listcourses",
		"discussions": "/cmd?cmd=getmessagelist",
		"discussions-cmd?cmd=listrestorablemessages": "/cmd?cmd=listrestorablemessages",
		"domains":                             "/cmd?cmd=listdomains",
		"domains-cmd?cmd=getdomainparentlist": "/cmd?cmd=getdomainparentlist",
		"enrollments":                         "/cmd?cmd=listenrollments",
		"enrollments-cmd?cmd=getenrollmentgrouplist":   "/cmd?cmd=getenrollmentgrouplist",
		"enrollments-cmd?cmd=listenrollmentsbyteacher": "/cmd?cmd=listenrollmentsbyteacher",
		"enrollments-cmd?cmd=listentityenrollments":    "/cmd?cmd=listentityenrollments",
		"enrollments-cmd?cmd=listuserenrollments":      "/cmd?cmd=listuserenrollments",
		"files":                                       "/cmd?cmd=getresourcelist2",
		"files-cmd?cmd=listrestorabledocuments":       "/cmd?cmd=listrestorabledocuments",
		"files-cmd?cmd=listrestorableresources":       "/cmd?cmd=listrestorableresources",
		"gradebook":                                   "/cmd?cmd=getduesoonlist",
		"gradebook-cmd?cmd=getgradebooklist":          "/cmd?cmd=getgradebooklist",
		"groups":                                      "/cmd?cmd=getgrouplist",
		"groups-cmd?cmd=getgroupenrollmentlist":       "/cmd?cmd=getgroupenrollmentlist",
		"items":                                       "/cmd?cmd=search2",
		"items-cmd?cmd=findpersonalizedentities":      "/cmd?cmd=findpersonalizedentities",
		"items-cmd?cmd=getitemlist":                   "/cmd?cmd=getitemlist",
		"items-cmd?cmd=listassignableitems":           "/cmd?cmd=listassignableitems",
		"items-cmd?cmd=listrestorableitems":           "/cmd?cmd=listrestorableitems",
		"objectives":                                  "/cmd?cmd=getobjectivelist",
		"objectives-cmd?cmd=getobjectivemaplist":      "/cmd?cmd=getobjectivemaplist",
		"objectives-cmd?cmd=getobjectivesubjectlist":  "/cmd?cmd=getobjectivesubjectlist",
		"objectives-cmd?cmd=listobjectivesets":        "/cmd?cmd=listobjectivesets",
		"peergrading":                                 "/cmd?cmd=getpeerreviewlist",
		"reports":                                     "/cmd?cmd=getreportlist",
		"reports-cmd?cmd=getrunnablereportlist":       "/cmd?cmd=getrunnablereportlist",
		"rights":                                      "/cmd?cmd=listroles",
		"rights-cmd?cmd=geteffectivesubscriptionlist": "/cmd?cmd=geteffectivesubscriptionlist",
		"rights-cmd?cmd=getentitysubscriptionlist":    "/cmd?cmd=getentitysubscriptionlist",
		"rights-cmd?cmd=getrightslist":                "/cmd?cmd=getrightslist",
		"rights-cmd?cmd=getsubscriptionlist":          "/cmd?cmd=getsubscriptionlist",
		"system":                                      "/cmd?cmd=getcommandlist",
		"tokens":                                      "/cmd?cmd=listcommandtokens",
		"users":                                       "/cmd?cmd=listusers",
		"wikis":                                       "/cmd?cmd=getwikipagelist",
		"wikis-cmd?cmd=listrestorablewikipages":       "/cmd?cmd=listrestorablewikipages",
	}

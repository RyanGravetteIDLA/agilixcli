...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "agilix-buzz-pp-cli",
		Short: `The first maintained, agent-native CLI for Agilix Buzz — every DLAP command plus offline activity analytics, content review, and a local database no other Buzz tool has.`,
		Long: `The first maintained, agent-native CLI for Agilix Buzz — every DLAP command plus offline activity analytics, content review, and a local database no other Buzz tool has.
...
Health check: run 'agilix-buzz-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("agilix-buzz-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'agilix-buzz-pp-cli profile list')")
	...
	rootCmd.AddCommand(newWikisCmd(flags))
	...
	rootCmd.AddCommand(newNovelClassCmd(flags))
	rootCmd.AddCommand(newNovelContentCmd(flags))
	rootCmd.AddCommand(newNovelReconcileCmd(flags))
	rootCmd.AddCommand(newNovelRolesCmd(flags))
	rootCmd.AddCommand(newNovelStudentsCmd(flags))
	rootCmd.AddCommand(newNovelTeacherCmd(flags))

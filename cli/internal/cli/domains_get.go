...
func newDomainsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Short:       "This command gets information for the specified domain.",
		Example:     "  agilix-buzz-pp-cli domains get --domainid 254591853 --json",
		Annotations: map[string]string{"pp:endpoint": "domains.get", "pp:method": "GET", "pp:path": "/cmd?cmd=getdomain2", "mcp:read-only": "true"},

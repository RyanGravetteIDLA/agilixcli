...
func newItemsRestoreCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "restore",
		Short:       "This command restores one or more items in a manifest.",
		Example:     "  agilix-buzz-pp-cli items restore",
		Annotations: map[string]string{"pp:endpoint": "items.restore", "pp:method": "POST", "pp:path": "/cmd?cmd=restoreitems"},

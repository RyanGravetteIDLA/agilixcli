...
func newGroupsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Short:       "This command gets information for a particular group.",
		Example:     "  agilix-buzz-pp-cli groups get",
		Annotations: map[string]string{"pp:endpoint": "groups.get", "pp:method": "GET", "pp:path": "/cmd?cmd=getgroup", "mcp:read-only": "true"},

...
func newFilesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Short:       "This command gets resource metadata and/or binary content for the course, section, enrollment, user, or domain.",
		Example:     "  agilix-buzz-pp-cli files get",
		Annotations: map[string]string{"pp:endpoint": "files.get", "pp:method": "GET", "pp:path": "/cmd?cmd=getresource", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagAttachment != "" {
				params["attachment"] = formatCLIParamValue(flagAttachment)
			}
			if flagClass != "" {
	...
	cmd.Flags().StringVar(&flagAttachment, "attachment", "", "")

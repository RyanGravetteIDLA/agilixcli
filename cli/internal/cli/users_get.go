...
func newUsersGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Short:       "This command gets information for a particular user.",
		Example:     "  agilix-buzz-pp-cli users get",
		Annotations: map[string]string{"pp:endpoint": "users.get", "pp:method": "GET", "pp:path": "/cmd?cmd=getuser2", "mcp:read-only": "true"},

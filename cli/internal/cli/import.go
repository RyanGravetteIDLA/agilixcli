...
but do not stop the import.`,
  ...
  agilix-buzz-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  agilix-buzz-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | agilix-buzz-pp-cli import <resource> --input -`,
